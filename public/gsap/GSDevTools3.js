...
!(function (e, t) {
        ...
        t &&
          (o
            ? ((f = f || w(e)),
              ...
              f.appendChild(l))
            : (h || ((h = w(e)).style.cssText = s), (l.style.cssText = s + "width:0.1px;height:0.1px;top:" + a + "px;left:" + r + "px"), h.appendChild(l))),
        l
      );
    }
    ...
    _ = function _forceNonZeroScale(e) {
      for (var t, o; e && e !== r; )
        (o = e._gsap) && o.uncache && o.get(e, "x"),
          o && !o.scaleX && !o.scaleY && o.renderTransform && ((o.scaleX = o.scaleY = 1e-4), o.renderTransform(1, o), t ? t.push(o) : (t = [o])),
          (e = e.parentNode);
      return t;
    },
    M = [],
    ...
    C = function _placeSiblings(e, t) {
      ...
      if ((d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), (o = l ? f : h), l))
              ...
              -(i = (function _getCTM(e) {
                ...
                return (
                  o ||
                    ...
                    (o = v.getCTM()),
                    e.removeChild(v),
                    t ? (e.style[b] = t) : e.style.removeProperty(b.replace(/([A-Z])/g, "-$1").toLowerCase())),
                  o || m.clone()
                );
              })(e)).e / i.a),
            (a = -i.f / i.d),
        ...
        if ("absolute" !== (s = u.getComputedStyle(e)).position && "fixed" !== s.position)
          for (n = e.offsetParent; p && p !== n; ) (r += p.scrollLeft || 0), (a += p.scrollTop || 0), (p = p.parentNode);
  ...
  function getGlobalMatrix(e, t, o, n) {
    ...
    if ((d.removeChild(a), i)) for (s = i.length; s--; ) ((l = i[s]).scaleX = l.scaleY = 0), l.renderTransform(1, l);
  ...
  function ra(e, t) {
    for (var o, n = e.length; n--; ) t ? (e[n].style.touchAction = t) : e[n].style.removeProperty("touch-action"), (o = e[n].children) && o.length && ra(o, t);
  }
  function sa() {
  ...
  function Ta(e) {
    ...
    return (
      ...
      (!(
        ...
        ("false" === t || (!e.onclick && !n.test(e.nodeName + "") && "true" !== e.getAttribute("contentEditable")))
      ) ||
        Ta(e.parentNode))
    );
  }
  ...
  function Ya(r, i) {
    ...
    var a,
      ...
      y = 0,
      w = 0;
    L && !1 !== i.force3D ? ((c = "translate3d("), (d = "px,0px)")) : N && ((c = "translate("), (d = "px)")),
      ...
      (this.left = function (e, t) {
        ...
        (e = -e) < 0 ? ((h = (e - 0.5) | 0), (e = 0)) : y < e ? ((h = (e - y) | 0), (e = y)) : (h = 0),
          (h || n) && (this._skip || (u[N] = c + -h + "px," + -g + d), 0 <= h + b && (u.paddingRight = h + b + "px")),
          (r.scrollLeft = 0 | e),
          (m = r.scrollLeft);
      }),
      (this.top = function (e, t) {
        ...
        (e = -e) < 0 ? ((g = (e - 0.5) | 0), (e = 0)) : w < e ? ((g = (e - w) | 0), (e = w)) : (g = 0),
        ...
        (f = r.scrollTop),
          ...
          (i && r.clientHeight === s && p.offsetHeight === l && v === r.scrollWidth && x === r.scrollHeight && !e) ||
            ...
            (i && !e) ||
              ...
              (u.width = "auto"),
              (u.paddingRight = "0px"),
              (b = Math.max(0, r.scrollWidth - r.clientWidth)) && (b += parseFloat(t.paddingLeft) + (O ? parseFloat(t.paddingRight) : 0))),
  ...
  function Za(e) {
    if (V() && document.body) {
      ...
      (me = window),
        ...
        ((be = da("div")).style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab"),
        ...
        (r.position = "relative"),
        (n.style.cssText = "width:90px;height:40px;padding:10px;overflow:auto;visibility:hidden"),
        n.appendChild(i),
        a.appendChild(n),
    ...
    var o, n, i, r, a;
    fe
      ? ((Se = fe.plugins.inertia), (c = fe.utils.checkPrefix), (N = c(N)), (Ce = c(Ce)), (we = fe.utils.toArray), (L = !!c("perspective")))
        ...
        return h || !o
          ...
          : ((r = -1 !== (o + "").indexOf("%")),
            ...
            !(n.width < 0 || n.height < 0) &&
              (r ? u * g * (o *= 0.01) <= (i = n.width * n.height) || i >= s.width * s.height * o : n.width > o && n.height > o));
      }),
      Draggable);
  function Draggable(g, p) {
      ...
      if ($.autoScroll && $.isDragging && (ee || C)) {
        ...
        for (
          ee = !1,
            ...
            Ae.scrollLeft =
              null != me.pageXOffset ? me.pageXOffset : null != ce.documentElement.scrollLeft ? ce.documentElement.scrollLeft : ce.body.scrollLeft,
          ...
          (t = (o = Ie(c.parentNode)) ? Ae : c.parentNode),
            ...
            j &&
              ...
              a && (t.scrollLeft += a)),
            o && (a || s) && (me.scrollTo(t.scrollLeft, t.scrollTop), ue($.pointerX + a, $.pointerY + s)),
            (c = t);
      }
      if (C) {
        var p = $.x,
          u = $.y;
        G
          ? (($.deltaX = p - parseFloat(se.rotation)), ($.rotation = p), (se.rotation = p + "deg"), se.renderTransform(1, se))
          : h
          ? (q && (($.deltaY = u - h.top()), h.top(u)), j && (($.deltaX = p - h.left()), h.left(p)))
          : W
          ? (q && (($.deltaY = u - parseFloat(se.y)), (se.y = u + "px")),
            j && (($.deltaX = p - parseFloat(se.x)), (se.x = p + "px")),
            se.renderTransform(1, se))
          : (q && (($.deltaY = u - parseFloat(g.style.top || 0)), (g.style.top = u + "px")),
            j && (($.deltaX = p - parseFloat(g.style.left || 0)), (g.style.left = p + "px"))),
          !f || e || A || (!(A = !0) === Oa($, "drag", "onDrag") && (j && ($.x -= $.deltaX), q && ($.y -= $.deltaY), ti(!0)), (A = !1));
      }
      C = !1;
    }
    function ui(e, t) {
      ...
      g._gsap || (se = fe.core.getCache(g)),
        ...
        W
          ...
          : h
          ? (($.y = h.top()), ($.x = h.left()))
          : (($.y = parseFloat(g.style.top || ((n = La(g)) && n.top)) || 0), ($.x = parseFloat(g.style.left || (n || {}).left) || 0)),
        (L || O || N) &&
          !t &&
          ($.isDragging || $.isThrowing) &&
          (N && ((Be.x = $.x), (Be.y = $.y), (o = N(Be)).x !== $.x && (($.x = o.x), (C = !0)), o.y !== $.y && (($.y = o.y), (C = !0))),
          L && (o = L($.x)) !== $.x && (($.x = o), G && ($.rotation = o), (C = !0)),
          O && ((o = O($.y)) !== $.y && ($.y = o), (C = !0))),
        C && ti(!0),
        e || (($.deltaX = $.x - i), ($.deltaY = $.y - r), Oa($, "throwupdate", "onThrowUpdate"));
    }
    function vi(a, s, l, o) {
      return (
        null == s && (s = -Oe),
        ...
        X(a)
          ? function (e) {
              ...
              return a.call($, l < e ? l + (e - l) * t : e < s ? s + (e - s) * t : e) * o;
            }
          : Le(a)
          ? function (e) {
              for (var t, o, n = a.length, i = 0, r = Oe; -1 < --n; ) (o = (t = a[n]) - e) < 0 && (o = -o), o < r && s <= t && t <= l && ((i = n), (r = o));
              return a[i];
            }
          : isNaN(a)
          ? function (e) {
    ...
    function xi() {
      ...
      (M = !1),
        h
          ? (h.calibrate(), ($.minX = D = -h.maxScrollLeft()), ($.minY = P = -h.maxScrollTop()), ($.maxX = k = $.maxY = S = 0), (M = !0))
          : p.bounds &&
            ((e = Pa(p.bounds, g.parentNode)),
            G
              ? (($.minX = D = e.left), ($.maxX = k = e.left + e.width), ($.minY = P = $.maxY = S = 0))
              ...
              : ((e = p.bounds), ($.minX = D = e.minX), ($.minY = P = e.minY), ($.maxX = k = e.maxX), ($.maxY = S = e.maxY)),
        ...
        p.liveSnap &&
          ...
          G
                  ...
                  X(l)
                    ? function (e) {
                        ...
                        return (
                          ...
                          (t = l.call($, e)) !== e && ((e.x = t.x), (e.y = t.y)),
                          1 !== g && ((e.x *= g), (e.y *= g)),
                          u < Oe && ((o = e.x - r), (n = e.y - a), u < o * o + n * n && ((e.x = r), (e.y = a))),
                          e
                        );
                      }
                    : Le(l)
                    ? function (e) {
                        for (var t, o, n, i, r = l.length, a = 0, s = Oe; -1 < --r; )
            ...
            : (j && (L = vi(n ? o : o.x || o.left || o.scrollLeft, D, k, h ? -1 : 1)), q && (O = vi(n ? o : o.y || o.top || o.scrollTop, P, S, h ? -1 : 1))));
    }
    function yi() {
    ...
    function Ai(e, t) {
      ...
      e && Se
        ? (!0 === e &&
            ...
            (n = Le(o) || X(o)),
            (e = {
              resistance: (p.throwResistance || p.resistance || 1e3) / (G ? 10 : 1),
            }),
            G
              ? (e.rotation = Sa($, n ? o : o.rotation, k, D, 1, t))
              : (j && (e[V] = Sa($, n ? o : o.points || o.x || o.left, k, D, h ? -1 : 1, t || "x" === $.lockedAxis)),
                q && (e[K] = Sa($, n ? o : o.points || o.y || o.top, S, P, h ? -1 : 1, t || "y" === $.lockedAxis)),
                (o.points || (Le(o) && Y(o[0]))) && ((e.linkedProps = V + "," + K), (e.radius = o.radius)))),
          ($.isThrowing = !0),
          (r = isNaN(p.overshootTolerance) ? (1 === p.edgeResistance ? 0 : 1 - $.edgeResistance + 0.2) : p.overshootTolerance),
          e.duration ||
            (e.duration = {
              max: Math.max(p.minDuration || 0, "maxDuration" in p ? p.maxDuration : 2),
              min: isNaN(p.minDuration) ? (0 === r || (Y(e) && 1e3 < e.resistance) ? 0 : 0.5) : p.minDuration,
              overshoot: r,
            }),
          ($.tween = i =
            fe.to(h || g, {
              ...
              onUpdateParams: p.fastMode ? [$, "onthrowupdate", "onThrowUpdate"] : o && o.radius ? [!1, !0] : [],
            })),
          p.fastMode ||
            (h && (h._skip = !0),
            i.render(1e9, !0, !0),
      ...
      Bi(!1),
        ...
        h
          ...
          : (de() ? (ui(!0, !0), xi()) : $.applyBounds(),
            G
              ? ((e = g.ownerSVGElement ? [se.xOrigin - g.getBBox().x, se.yOrigin - g.getBBox().y] : (La(g)[Ce] || "0 0").split(" ")),
                (E = $.rotationOrigin =
              ...
              : ((_ = Mh(K, "px")), (T = Mh(V, "px")))),
        M && n && (k < T ? (T = k + (T - k) / n) : T < D && (T = D - (D - T) / n), G || (S < _ ? (_ = S + (_ - S) / n) : _ < P && (_ = P - (P - _) / n))),
        ($.startX = T = ba(T)),
        ($.startY = _ = ba(_));
    }
    function Ei() {
    ...
    function Fi(e, t) {
      var o;
      if (!u || $.isPressed || !e || (!(("mousedown" !== e.type && "pointerdown" !== e.type) || t) && Ye() - ae < 30 && _e[$.pointerEvent.type]))
        F && e && u && za(e);
      else {
        if (
          ((R = de()),
          ($.pointerEvent = e),
          _e[e.type]
            ? ((b = ~e.type.indexOf("touch") ? e.currentTarget || e.target : ce),
              xa(b, "touchend", ge),
              xa(b, "touchmove", pe),
              xa(b, "touchcancel", ge),
              xa(ce, "touchstart", Ca))
          ...
          (B = null),
          (Ee && b) || (xa(ce, "mouseup", ge), e && e.target && xa(e.target, "mouseup", ge)),
          (x = re.call($, e.target) && !1 === p.dragClickables && !t))
        )
          return xa(e.target, "change", ge), Oa($, "pressInit", "onPressInit"), Oa($, "press", "onPress"), Ua(Q, !0), void (F = !1);
        if (
          ((H = !(!b || j == q || !1 === $.vars.allowNativeTouchScrolling || ($.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which))) && (j ? "y" : "x")),
          (F = !H && !$.allowEventDefault) && (za(e), xa(me, "touchforcechange", za)),
          ...
          !g.parentNode ||
            ...
            be.parentNode ||
            g.getBBox ||
            ((be.style.width = g.parentNode.scrollWidth + "px"), g.parentNode.appendChild(be)),
          Ci(),
          $.tween && $.tween.kill(),
          ($.isThrowing = !1),
          ...
          (!p.zIndexBoost && (G || h || !1 === p.zIndexBoost)) || (g.style.zIndex = Draggable.zIndex++),
          ($.isPressed = !0),
          ...
          for (o = Q.length; -1 < --o; )
            fe.set(Q[o], {
              cursor: p.activeCursor || p.cursor || ("grab" === Pe ? "grabbing" : Pe),
            });
        Oa($, "press", "onPress");
      }
    }
    function Ji(e) {
      if (e && $.isDragging && !h) {
        ...
        (o || n) &&
          (z ? ((y -= o * z.a + n * z.c), (w -= n * z.d + o * z.b)) : ((y -= o), (w -= n)),
          (t._gsScrollX += o),
          (t._gsScrollY += n),
    ...
    function Ki(e) {
      ...
      if (
        ((i || (n && !1 !== $.vars.suppressClickOnDrag)) && e.stopImmediatePropagation && e.stopImmediatePropagation(),
        o && (!$.pointerEvent || !$.pointerEvent.defaultPrevented) && (!i || (s && !a)))
      )
        return s && i && (c = ae), void (I = ae);
      ($.isPressed || n || o) && ((s && e.detail && o && !r) || za(e)), o || n || (e && e.target && ($.pointerEvent = e), Oa($, "click", "onClick"));
    }
    function Li(e) {
      return z
        ? {
    ...
    var u,
      ...
      pe = function onMove(e) {
        ...
        if (u && !ke && $.isPressed && e) {
          ...
          (o = Fe.x),
          (n = Fe.y),
          (((r = Math.abs(o - y)) !== (a = Math.abs(n - w)) && (J < r || J < a)) || (De && H === B)) &&
            ((B = a < r && j ? "x" : "y"),
            H && B !== H && xa(me, "touchforcechange", za),
            !1 !== $.vars.lockAxisOnTouchScroll && j && q && (($.lockedAxis = "x" === B ? "y" : "x"), X($.vars.onLockAxis) && $.vars.onLockAxis.call($, s)),
            De && H === B))
            ? ge(s)
            : ((F = $.allowEventDefault || (H && (!B || H === B)) || !1 === s.cancelable ? F && !1 : (za(s), !0)),
              $.autoScroll && (ee = !0),
        ...
        ($.pointerX = e),
          ...
          G
            ? ((a = Math.atan2(E.y - t, e - E.x) * Xe),
              180 < (s = $.y - a) ? ((_ -= 360), ($.y = a)) : s < -180 && ((_ += 360), ($.y = a)),
              (r = $.x !== T || Math.abs(_ - a) > J ? (($.y = a), T + (_ - a) * c) : T))
            : (z && ((l = e * z.a + t * z.c + z.e), (t = e * z.b + t * z.d + z.f), (e = l)),
              ...
              ($.lockAxis || $.lockedAxis) &&
                (n || i) &&
                ((l = $.lockedAxis) ||
                  (($.lockedAxis = l = j && Math.abs(n) > Math.abs(i) ? "y" : q ? "x" : null),
                  l && X($.vars.onLockAxis) && $.vars.onLockAxis.call($, $.pointerEvent)),
                "y" === l ? (i = 0) : "x" === l && (n = 0)),
              (r = ba(T + n * c)),
              (a = ba(_ + i * c))),
          (L || O || N) &&
            ($.x !== r || ($.y !== a && !G)) &&
            (N && ((Be.x = r), (Be.y = a), (l = N(Be)), (r = ba(l.x)), (a = ba(l.y))), L && (r = ba(L(r))), O && (a = ba(O(a)))),
          M &&
            (k < r ? (r = k + Math.round((r - k) * d)) : r < D && (r = D + Math.round((r - D) * d)),
            G || (S < a ? (a = Math.round(S + (a - S) * d)) : a < P && (a = Math.round(P + (a - P) * d)))),
          ($.x === r && ($.y === a || G)) ||
            (G ? (($.endRotation = $.x = $.endX = r), (C = !0)) : (q && (($.y = $.endY = a), (C = !0)), j && (($.x = $.endX = r), (C = !0))),
            o && !1 === Oa($, "move", "onMove")
              ? (($.pointerX = p), ($.pointerY = u), (_ = g), ($.x = h), ($.y = f), ($.endX = m), ($.endY = v), ($.endRotation = x), (C = b))
              : !$.isDragging && $.isPressed && (($.isDragging = !0), Oa($, "dragstart", "onDragStart")));
      },
      ge = function onRelease(e, t) {
        if (
          ...
          if (
            (b ? (ya(b, "touchend", onRelease), ya(b, "touchmove", pe), ya(b, "touchcancel", onRelease), ya(ce, "touchstart", Ca)) : ya(ce, "mousemove", pe),
            ya(me, "touchforcechange", za),
            (Ee && b) || (ya(ce, "mouseup", onRelease), e && e.target && ya(e.target, "mouseup", onRelease)),
            (C = !1),
            l && ((U = He = Ye()), ($.isDragging = !1)),
            x && !c)
          )
            return (
              e && (ya(e.target, "change", onRelease), ($.pointerEvent = s)), Ua(Q, !1), Oa($, "release", "onRelease"), Oa($, "click", "onClick"), void (x = !1)
            );
          for (va(ti), n = Q.length; -1 < --n; ) Ka(Q[n], "cursor", p.cursor || (!1 !== p.cursor ? Pe : null));
          if ((Me--, e)) {
            if ((o = e.changedTouches) && (e = o[0]) !== m && e.identifier !== v) {
              for (n = o.length; -1 < --n && (e = o[n]).identifier !== v && e.target !== g; );
              if (n < 0) return;
            }
            ($.pointerEvent = s), ($.pointerX = e.pageX), ($.pointerY = e.pageY);
          }
          return (
            c && s
              ...
              : (Ai(p.inertia || p.throwProps),
                $.allowEventDefault || !s || (!1 === p.dragClickables && re.call($, s.target)) || !l || (H && (!B || H !== B)) || !1 === s.cancelable
                  ? (F = !1)
                  : ((F = !0), za(s)),
                Oa($, "release", "onRelease")),
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        ...
        Fi(e || $.pointerEvent, !0),
          t &&
            ...
            (y -= i.x - r.x),
            (w -= i.y - r.y)),
          $.isDragging || (($.isDragging = !0), Oa($, "dragstart", "onDragStart"));
      }),
      (e.drag = pe),
      ...
      (e.getDirection = function (e, t) {
        ...
        return (
          ...
          (o = "start" === l ? $.x - T : "velocity" === l ? Se.getVelocity(g, V) : a.left + a.width / 2 - (s.left + s.width / 2)),
          G
            ? o < 0
              ? "counter-clockwise"
              : "clockwise"
            : ((t = t || 2),
              (n = "start" === l ? $.y - _ : "velocity" === l ? Se.getVelocity(g, K) : a.top + a.height / 2 - (s.top + s.height / 2)),
      ...
      (e.applyBounds = function (e, t) {
        ...
        if ((ui(!0), xi(), M && !de())) {
          if (
            ...
            S < n ? (n = S) : n < P && (n = P),
            ($.x !== o || $.y !== n) &&
              ((i = !0), ($.x = $.endX = o), G ? ($.endRotation = o) : ($.y = $.endY = n), ti((C = !0)), $.autoScroll && !$.isDragging))
          )
            for (
              Ja(g.parentNode),
                r = g,
                Ae.scrollTop =
                  null != me.pageYOffset ? me.pageYOffset : null != ce.documentElement.scrollTop ? ce.documentElement.scrollTop : ce.body.scrollTop,
                Ae.scrollLeft =
                  null != me.pageXOffset ? me.pageXOffset : null != ce.documentElement.scrollLeft ? ce.documentElement.scrollLeft : ce.body.scrollLeft;
              r && !s;
              ...
              (a = (s = Ie(r.parentNode)) ? Ae : r.parentNode),
                ...
                j && a.scrollLeft > a._gsMaxScrollX && (a.scrollLeft = a._gsMaxScrollX),
                (r = a);
          $.isThrowing && (i || $.endX > k || $.endX < D || $.endY > S || $.endY < P) && Ai(p.inertia || p.throwProps, i);
        }
        return $;
      }),
      (e.update = function (e, t, o) {
        ...
        return (
          ...
          $.isPressed && !t && ((j && 0.01 < Math.abs(a - $.x)) || (q && 0.01 < Math.abs(s - $.y) && !G)) && Ci(),
          $.autoScroll && (Ja(g.parentNode, $.isDragging), (ee = $.isDragging), ti(!0), Ga(g, Ji), Fa(g, Ji)),
          $
        );
      }),
      (e.enable = function (e) {
        ...
        if ((!1 !== p.cursor && (i.cursor = p.cursor || Pe), fe.utils.checkPrefix("touchCallout") && (i.touchCallout = "none"), "soft" !== e)) {
          for (
            ra(
              ...
              j == q
                ? "none"
                : (p.allowNativeTouchScrolling && (g.scrollHeight === g.clientHeight) == (g.scrollWidth === g.clientHeight)) || p.allowEventDefault
                ? "manipulation"
                : j
                ? "pan-y"
                : "pan-x"
            ...
            (n = Q[o]),
              ...
              n.getBBox &&
                ...
                fe.set(n.ownerSVGElement, {
                  touchAction: j == q ? "none" : p.allowNativeTouchScrolling || p.allowEventDefault ? "manipulation" : j ? "pan-y" : "pan-x",
                }),
        ...
        return (
          Fa(g, Ji),
          (u = !0),
          Se && "soft" !== e && Se.track(h || g, W ? "x,y" : G ? "rotation" : "top,left"),
          (g._gsDragID = t = "d" + Re++),
          (ze[t] = $),
      ...
      (e.disable = function (e) {
        for (var t, o = $.isDragging, n = Q.length; -1 < --n; ) Ka(Q[n], "cursor", null);
        if ("soft" !== e) {
          for (ra(Q, null), n = Q.length; -1 < --n; )
            (t = Q[n]), Ka(t, "touchCallout", null), ya(t, "mousedown", Fi), ya(t, "touchstart", Fi), ya(t, "click", Ki), ya(t, "contextmenu", si);
          Ua(Q, !0), b && (ya(b, "touchcancel", ge), ya(b, "touchend", ge), ya(b, "touchmove", pe)), ya(ce, "mouseup", ge), ya(ce, "mousemove", pe);
        }
        return (
          Ga(g, Ji),
          (u = !1),
          Se && "soft" !== e && Se.untrack(h || g, W ? "x,y" : G ? "rotation" : "top,left"),
          h && h.disable(),
          va(ti),
  ...
  function Gb(e, t, o) {
    var n = J.createElementNS ? J.createElementNS("svg" === e ? G : ce, e) : J.createElement(e);
    return (
      t && (rb(t) && (t = J.querySelector(t)), t.appendChild(n)),
      "svg" === e && (n.setAttribute("xmlns", G), n.setAttribute("xmlns:xlink", ce)),
      o && (n.style.cssText = o),
      n
    );
  }
    ...
    if (oe) {
      for (e = U._dur; n; )
        (t = n._next),
          ...
          (sb(o) && o === n.vars.onComplete && !n._dur) || (o && o._gsIgnore) || U.add(n, n._start - n._delay),
          (n = t);
      return e !== U.duration();
    }
  }
  ...
  var j,
    ...
    G =
      ((function (e) {
        var t = "undefined" != typeof window,
          o =
            0 === (t ? window.location.href : "").indexOf(xb(102, 105, 108, 101, 58, 47, 47)) ||
          ...
          n = [
            ...
            xb(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
            xb(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
            xb(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
            xb(99, 111, 100, 101, 112, 101, 110, 46, 119, 101, 98, 115, 105, 116, 101),
            ...
            xb(99, 111, 100, 101, 99, 97, 110, 121, 111, 110, 46, 110, 101, 116),
            xb(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
            ...
            xb(99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111),
            ...
            xb(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
            xb(115, 116, 97, 99, 107, 111, 118, 101, 114, 102, 108, 111, 119, 46, 99, 111, 109),
            xb(115, 116, 97, 99, 107, 101, 120, 99, 104, 97, 110, 103, 101, 46, 99, 111, 109),
              ...
              ("loading" === document.readyState || "interactive" === document.readyState
                ...
                : (document.removeEventListener("readystatechange", checkWarn),
                  t &&
                    ...
                    (console.log(
                      xb(37, 99, 87, 97, 114, 110, 105, 110, 103),
                      xb(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)
                    ),
                    console.log(
                      xb(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                        I +
                        xb(
                          32,
                          105,
                    ...
                    console.log(
                      ...
                      xb(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 49, 54, 112, 120, 59, 99, 111, 108, 111, 114, 58, 35, 52, 101, 57, 56, 49, 53)
                    ),
          ...
          setTimeout(function () {
            t &&
              (window.location.href =
                xb(104, 116, 116, 112, 115, 58, 47, 47) +
                F +
                xb(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) +
                "?plugin=" +
                I +
                "&source=trial");
          }, 3e3);
    ...
    Ge = function GSDevTools(r) {
      ...
      function Oo() {
        (D = 0), (S = 100), (M.style.left = "0%"), (k.style.left = "100%"), eo("in", D), eo("out", S), H(!0);
      }
      function So(e) {
        if (!N.isPressed) {
          var t = e.target.getBoundingClientRect(),
            o = (((e.changedTouches ? e.changedTouches[0] : e).clientX - t.left) / t.width) * 100;
          if (o < D) return (D = o = Math.max(0, o)), (M.style.left = D + "%"), void z.startDrag(e);
          if (S < o) return (S = o = Math.min(100, o)), (k.style.left = S + "%"), void R.startDrag(e);
      ...
      function Wo() {
        if (!N.isPressed) {
          ...
          e === i && e.seek(s + ((l - s) * D) / 100), v.progress(D / 100, !0), C || v.resume();
        }
      }
      function Xo(e) {
        if ((eo("loop", (d = e)), d)) {
      ...
      function $o(e) {
        ...
        if (
          ...
          if (
            ...
            if (
              (Tb(), (v = te), oe && oe !== p && console.warn("Error: GSDevTools can only have one instance that's globally synchronized."), (oe = p), i !== U)
            )
      ...
      function ap(e) {
        $o(P.options[P.selectedIndex].animation), e.target && e.target.blur && e.target.blur(), C && B();
      }
      function bp() {
        var e,
        ...
        v.timeScale(t),
          ...
          C ||
            (v.progress() >= S / 100
              ? ((e = v._targets && v._targets[0]) === i && e.seek(s + ((l - s) * D) / 100), v.progress(D / 100, !0).pause())
              : v.pause(),
            re(0.01, function () {
              return v.resume();
            })),
      ...
      function ep(e) {
        K.hitTest(e, n) || N.isDragging || z.isDragging || R.isDragging || G.restart(!0);
      }
      function fp() {
      ...
      function jp(e) {
        ...
        t && ((t._inProgress = fo("in") || 0), (t._outProgress = fo("out") || 100)), r.paused && A(), (i = null), $o(a || t || U);
        var o = r.timeScale || fo("timeScale"),
          n = t === i;
        o && (Rb(O, o, Y, o + "x"), v.timeScale(o)),
          100 === (D = ("inTime" in r ? Lb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) && !r.animation && t && ($o(U), (D = Lb(r.inTime, i, 0, 0) || 0)),
          D && ((M.style.left = D + "%"), (M.style.display = k.style.display = "block")),
          (S = ("outTime" in r ? Lb(r.outTime, i, 100, D) : n ? t._outProgress : 0) || 100) < D && (S = 100),
        ...
        N = K.create(x, {
          ...
          onDrag: function onDrag() {
            ...
            e < 0 ? (e = 0) : e > v._dur && (e = v._dur),
              f || v.time(e),
              (y.style.width = Math.min(S - D, Math.max(0, (e / v._dur) * 100 - D)) + "%"),
            ...
            100 < o && (o = 100),
              S <= o
                ? !d || v.paused() || N.isDragging
                  ? ((o === S && -1 !== i._repeat) || ((o = S), v.progress(o / 100)), !C && (S < 100 || 1 === i.totalProgress() || -1 === i._repeat) && A())
                  : n ||
                    ((o = D),
                    (t = v._targets && v._targets[0]) === i && t.seek(s + ((l - s) * D) / 100),
                    0 < i._repeat && !D && 100 === S ? 1 === i.totalProgress() && v.totalProgress(0, !0).resume() : v.progress(o / 100, !0).resume())
      ...
      Pb(P, "change", ap),
        ...
        Pb(L, "mousedown", Yo),
        Pb(O, "change", bp),
        "auto" === r.visibility ? (Pb(n, "mouseout", ep), Pb(n, "mouseover", gp)) : "hidden" === r.visibility && ((W = !0), F.progress(1)),
        !1 !== r.keyboard &&
          (ne && r.keyboard
              ...
              Pb(
                ...
                (e = function keyboardHandler(e) {
                  ...
                  32 === o
                    ? I()
                    : 38 === o
                    ? ((t = parseFloat(Sb(O, -1, Y))), v.timeScale(t), eo("timeScale", t))
                    : 40 === o
                    ? ((t = parseFloat(Sb(O, 1, Y))), v.timeScale(t), eo("timeScale", t))
                    : 37 === o
                    ? Wo()
                    ...
                    : 73 === o
                    ? ((D = 100 * v.progress()), eo("in", D), (M.style.left = D + "%"), H(!0))
                    : 79 === o && ((S = 100 * v.progress()), eo("out", S), (k.style.left = S + "%"), H(!0));
                })
              ))),
        j.set(x, {
          xPercent: -50,
        ...
        (M._gsIgnore = k._gsIgnore = x._gsIgnore = t._gsIgnore = L._gsIgnore = !0),
          ...
          oe === p &&
            ...
            (function updateRootDuration() {
              ...
              i === U &&
                ...
                1e3 === (o = Math.min(1e3, U.duration())) && (o = Math.min(1e3, Jb(U))),
                1 != (t = te.duration() / o) &&
                  o &&
                  ((D *= t),
                  S < 100 && (S *= t),
  ...
  (Ge.version = "3.10.5"),
    ...
    (Ge.getByAnimation = function (e) {
      for (var t in (rb(e) && (e = j.getById(e)), pe)) if (pe[t].animation() === e) return pe[t];
    }),
